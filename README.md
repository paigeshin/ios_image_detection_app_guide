# ios_image_detection_app_guide

Resource: [https://developer.apple.com/machine-learning/models/](https://developer.apple.com/machine-learning/models/)

Data Used for this app: `Resnet50` 

You can use `SqueezeNet`
